...
//                btn.setOnClickListener(Button_OnClickListener);
    ...
    public class MyBroastCast extends BroadcastReceiver {
        private static final String FINISH = "android.intent.action.FINISH";
        @Override
    ...
    protected void onStart() {
        super.onStart();
        receiver = new MyBroastCast();
        IntentFilter filter = new IntentFilter();
        filter.addAction("android.intent.action.FINISH");
